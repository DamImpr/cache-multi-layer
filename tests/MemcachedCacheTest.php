...
class MemcachedCacheTest extends AbstractCache
{
    ...
    {
        parent::setUp();
        $this->setCache(Cache::factory(CacheEnum::MEMCACHED, 60, ['server_address' => 'memcache-server']));
    }
    ...
    {
        $this->expectException(CacheMissingConfigurationException::class);
        Cache::factory(CacheEnum::MEMCACHED, 60, ['instance' => 5]);
    }

    public function testEnum(): void
    {
        $this->doTestRealEnum(CacheEnum::MEMCACHED);
    }
    ...
    public static function tearDownAfterClass(): void
    {
        ...
        Cache::factory(CacheEnum::MEMCACHED, 60, ['server_address' => 'memcache-server'])->clearAllCache();
    }
}
